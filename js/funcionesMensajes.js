function autoInicioRelacionCliente(){
    ...
    $.ajax({
        //url:"http://130.61.241.135:80/api/Client/all",
...
function autoInicioSkate(){
    ...
    $.ajax({
        //url:"http://130.61.241.135:80/api/Skate/all",
...
function autoInicioMensajes(){
    ...
    $.ajax({
        //url:"http://130.61.241.135:80/api/Message/all",
...
function guardarInformacionMensajes(){
    ...
    let var2 = {
        ...
        //url:"http://130.61.241.135:80/api/Message/save",
...
function actualizarInformacionMensaje(idElemento){
    ...
    $.ajax({
       // url:"http://130.61.241.135:80/api/Message/update",
...
function borrarMensaje(idElemento){
    ...
    $.ajax({
        //url:"http://130.61.241.135:80/api/Message/"+idElemento,
        url:"http://localhost:8080/api/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
